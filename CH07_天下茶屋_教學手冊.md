...
```json
{
  "mcpServers": {
    "weather": {
      "command": "npx",
      "args": ["-y", "@antigravity/weather-mcp-server"]
    },
    "line": {
      "command": "npx",
      "args": ["-y", "@antigravity/line-mcp-server"],
      "env": {
    ...
    "database": {
      "command": "npx",
      "args": ["-y", "@antigravity/libsql-mcp-server"],
      "env": {
        "LIBSQL_URL": "${env:TURSO_DB_URL}",
        "LIBSQL_AUTH_TOKEN": "${env:TURSO_DB_TOKEN}"
      }
    }
  }
}
